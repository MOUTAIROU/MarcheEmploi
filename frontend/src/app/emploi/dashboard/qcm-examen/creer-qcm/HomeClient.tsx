...
import { countryNumberCode, country, countryCode, CATEGORIE_LABELS } from "@/utils/types";
...
export default function OffresPage() {
    ...
    const handleSave = () => alert("QCM enregistré comme brouillon");
    ...
    const handlePublish = async () => {
        ...
        console.log("Données prêtes à l'envoi :", qcmData);
    ...
    async function submitQCM(payload: any) {
        ...
        console.log('oototoo')
        const response = await api.post("/entreprise/create_qcm", payload, {
    ...
    const sauvegarderQuestion = () => {
        ...
        if (questions.length >= MAX_QUESTIONS) {
            alert(`Vous ne pouvez pas ajouter plus de ${MAX_QUESTIONS} questions.`);
            return;
        }
                    ...
                    <div className="mainContent">
                        ...
                        <form className="qcm-form">
                                ...
                                {questions.map((q, i) => (
                                    <div key={q.id} className="question-box">
                                        <div className="question-header" onClick={() => toggleQuestion(q.id)}>
                                            <strong>
                                                Question ({i + 1}) — {q.intitule || "Sans titre"} ({q.niveau || "N/A"})
                                            </strong>
                                    ...
                                    <div className="question-form">
                                            ...
                                            <div className="section-content">
                                                ...
                                                {nouvelleQuestion.type === "reponse-texte" && (
                                                    <textarea
                                                        ...
                                                        value={texteOption}
                                                        onChange={(e) => setTexteOption(e.target.value)}
                                                    />
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div className="section">
                                            ...
                                            <textarea
                                                ...
                                                value={nouvelleQuestion.justification}
                                                onChange={(e) =>
                                                    setNouvelleQuestion({
                                                        ...nouvelleQuestion,
                            ...
                            <div className="button-row">
                                <button type="button" className="preview-btn" onClick={handlePreview}>✏️ Prévisualiser le QCM</button>
                                <button type="button" className="save-btn" onClick={handleSave}>💾 Enregistrer le brouillon</button>
                            </div>
