...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const savedSearch = JSON.parse(sessionStorage.getItem("candiddatSearch") || "{}");
        ...
        const fetchWithFilterAnnonces = async () => {
            try {
                ...
                const res = await apiWithSession.post(
                    `/frontend/candidat_recherche_emploi_by_page`,
                    { page, params: sessionStorage.getItem("candiddatSearch") }
                );
