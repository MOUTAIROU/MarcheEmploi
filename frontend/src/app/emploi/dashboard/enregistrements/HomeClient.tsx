...
interface Offre {
    ...
    post_id: string;               // OFF-xxx | AOF-xxx
    type: "offre_emploi" | "appel_offre" | string;
    objet: string;                 // Titre / objet de l’annonce
    user_info: string;
    createdAt: string;
    titre: string;
    source: string;
...
export default function OffresPage() {
    ...
    function getAnnonceHref(a: any) {
        ...
        if (a.type === "offre_emploi") {
            return `${process.env.LOCAL_HOST}/emploi/dashboard/recherche/annonces/emploi/${ville}/${slug}`;
        }
                                        ...
                                        <tr key={offre.post_id}>
                                            ...
                                            <td className='param-btn'>
                                                <button
                                                    ...
                                                    onClick={() =>
                                                        setOpenRowMenu(openRowMenu === offre.post_id.toString() ? null : offre.post_id.toString())
                                                    }
                                                >
                                                    ⚙️
                                                </button>

                                                {openRowMenu === offre.post_id.toString() && (
