...
export interface QualiteFormRef {
  getQualites: () => string[];
  fillQualitesFromParent: (values: string[]) => void;
}
...
const QualiteForm = forwardRef<QualiteFormRef, Props>(
  ({ initialCentres = [] }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      getQualites: () => centres,
      fillQualitesFromParent: (values: string[]) => {
        setCentres(values);
      },
    }));
    ...
    return (
      <div className="quality-content">
        ...
        <div className="inputCard">
          <label htmlFor="centreInput">Qualité</label>
          <input
            id="centreInput"
            type="text"
            value={inputValue}
