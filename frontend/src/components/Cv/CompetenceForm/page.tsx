...
export type CompetenceFormRef = {
  ...
  fillCompetencesFromParent: (liste: Competence[]) => void; // 👈 nouvelle méthode
};

const CompetenceForm = forwardRef<CompetenceFormRef>((_, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    fillCompetencesFromParent: (liste: Competence[]) => {
