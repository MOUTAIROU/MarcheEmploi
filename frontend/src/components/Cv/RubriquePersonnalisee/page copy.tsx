...
const RubriquesPersonnalisees = forwardRef<RubriquesPersonnaliseesRef>((props, ref) => {
  ...
  // Ajouter une nouvelle rubrique vide et la mettre en édition
  ...
  useImperativeHandle(ref, () => ({
    ...
    fillRubriquesPersonnaliseesFromParent: (data: RubriquePersonnalisee[]) => {
      ...
      if (data.length > 0) {
        setRubriqueEnEdition(data[0]);
        if (quill) {
          // Attendre un léger délai pour que Quill soit prêt
          setTimeout(() => {
